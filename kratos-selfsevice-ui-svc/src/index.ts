...
const cookieSecret = process.env.CSRF_COOKIE_SECRET || "pikachiu" // CSRF cookie secret, must be at least 8 characters long
...
app.use(cookieParser(process.env.COOKIE_SECRET || "pikachiu"))
